...
while j < loopend:
    ...
    while t < Tf + DOLFIN_EPS and iter < maxiter:
        ...
        Fu12 = dot(lhsFu12, v)*dx + \
               + inner(sigmacon(U, p0, tau0), Dincomp(v))*dx \
        ...
        rhs_tau12= (We/dt)*tau0 + Identity(len(u))                      # Right Hand Side
        ...
        Fus = dot(lhsFus, v)*dx + \
              + inner(sigmacon(U, p0, tau0), Dincomp(v))*dx \
              + 0.5*dot(p0*n, v)*ds - betav*(dot(nabla_grad(U)*n, v)*ds + (1.0/3)*dot(div(U)*n,v)*ds) \
              - ((1-betav)/We)*dot(tau0*n, v)*ds\
               + inner(D-Dcomp(u),R)*dx   
        ...
        rhs_p_1 = (Ma*Ma/(dt*Re))*p0 - dot(grad(rho0),us) - rho0*div(us)
        ...
        # Stress Full Step
        lhs_tau1 = (We/dt+1.0)*tau  +  We*Fdefcon(u1,tau)                            # Left Hand Side
    ...
    """if j==5:
        ...
        plt.plot(x_axis1[2], u_y1[2], 'c-', label=r'$Re=25$')
        plt.plot(x_axis1[2], u_y1[2], 'c-', label=r'$Re=50$')
        plt.legend(loc='best')
        plt.xlabel('x')
        plt.ylabel('$u_y(x,0.75)$')
        plt.savefig("Compressible Viscoelastic Flow Results/Cross Section/u_yRe="+str(Re*conv)+"x="+str(0.5)+"b="+str(betav)+"Ma="+str(Ma)+"dt="+str(dt)+".png")
        ...
        plt.plot(u_x1[2], y_axis1[2], 'c-', label=r'$Re=25$')
        plt.plot(u_x1[2], y_axis1[2], 'c-', label=r'$Re=50$')
        plt.legend(loc='best')
        plt.xlabel('$u_x(0.5,y)$')
        plt.ylabel('y')
        plt.savefig("Compressible Viscoelastic Flow Results/Cross Section/u_xRe="+str(Re*conv)+"x="+str(0.5)+"b="+str(betav)+"Ma="+str(Ma)+"dt="+str(dt)+".png")
        ...
        plt.plot(x_axis1[2], sig_xx1[2], 'c-', label=r'$Re=25$')
        plt.plot(x_axis1[2], sig_xx1[2], 'c-', label=r'$Re=50$')
        plt.legend(loc='best')
        plt.xlabel('x')
        plt.ylabel('$\tau_{xx}(x,1.0)$')
        plt.savefig("Compressible Viscoelastic Flow Results/Cross Section/tau_xxRe="+str(Re*conv)+"x="+str(0.5)+"b="+str(betav)+"Ma="+str(Ma)+"dt="+str(dt)+".png")
        ...
        plt.plot(x_axis1[2], sig_yy1[2], 'c-', label=r'$Re=25$')
        plt.plot(x_axis1[2], sig_yy1[2], 'c-', label=r'$Re=50$')
        plt.legend(loc='best')
        plt.xlabel('x')
        plt.ylabel('$\tau_{yy}(x,1.0)$')
        plt.savefig("Compressible Viscoelastic Flow Results/Cross Section/tau_yyRe="+str(Re*conv)+"x="+str(0.5)+"b="+str(betav)+"Ma="+str(Ma)+"dt="+str(dt)+".png")
        ...
        plt.plot(x_axis1[2], sig_xy1[2], 'c-', label=r'$Re=25$')
        plt.plot(x_axis1[2], sig_xy1[2], 'c-', label=r'$Re=50$')
        plt.legend(loc='best')
        plt.xlabel('x')
        plt.ylabel('$\tau_{xy}(x,1.0)$')
        plt.savefig("Compressible Viscoelastic Flow Results/Cross Section/tau_xyRe="+str(Re*conv)+"x="+str(0.5)+"b="+str(betav)+"Ma="+str(Ma)+"dt="+str(dt)+".png")
